...
public class MaterialTabHost extends RelativeLayout implements View.OnClickListener {
    ...
    public MaterialTabHost(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            try {
                // custom attributes
                primaryColor = a.getColor(R.styleable.MaterialTabHost_materialtab_primaryColor, Color.parseColor("#009688"));
                accentColor = a.getColor(R.styleable.MaterialTabHost_materialtab_accentColor, Color.parseColor("#00b0ff"));
                textColor = a.getColor(R.styleable.MaterialTabHost_materialtab_textColor, Color.WHITE);
            } finally {
                a.recycle();
            }
        }
